...
public class Scoreboard extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AccessToken.getCurrentAccessToken() != null)
        {
            ...
            url = getString(R.string.url) + "scoreboardTop10?accessToken=" + ((MyApplication) this.getApplication()).getAccessToken() + "&type=russesamfunnet";
        }
    ...
    private void getRussId() throws IOException {
        ...
        if (AccessToken.getCurrentAccessToken() != null)
        {
            ...
            newUrl = getString(R.string.url) + "userRuss?accessToken=" + ((MyApplication) this.getApplication()).getAccessToken() + "&type=russesamfunnet";
        }
        try {
